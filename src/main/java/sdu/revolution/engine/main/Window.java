...
import sdu.revolution.engine.main.Engine;
import sdu.revolution.engine.main.MouseInput;
...
public class Window {
    ...
    public Window(String title, WindowOptions options, Callable<Void> resizeFunc) {
        ...
        glfwSetErrorCallback((int errorCode, long msgPtr) -> Logger.getGlobal().severe("Error occurred."));
