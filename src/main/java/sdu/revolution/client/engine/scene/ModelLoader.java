...
import sdu.revolution.client.engine.graph.Material;
import sdu.revolution.client.engine.graph.Mesh;
...
public class ModelLoader {
    ...
    public static Model loadModel(String modelId, String modelPath, TextureCache textureCache, int flags) {
        ...
        if (numAnimations > 0) {
            ...
            Matrix4f globalInverseTransformation = toMatrix(Objects.requireNonNull(aiScene.mRootNode()).mTransformation()).invert();
